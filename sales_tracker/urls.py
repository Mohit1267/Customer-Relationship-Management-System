...
urlpatterns = [
    ...
    path("attendance/", login_required(views.Attendence), name="attendance"),
    path("maps", login_required(views.maps.as_view()), name="maps"),
    ...
    path("view_calling/", login_required(views.ViewScheduledCalls.as_view()), name="view_calling"),
    ...
    path("viewTemplate/", views.agent_template_view, name="viewTemplate"),
    path("createTemplate/", views.create_project_template, name="create_project_template"),
    path("Importtemplate/", login_required(views.upload_import_file), name="Importtemplate"),
    ...
    path("createCase/", login_required(views.add_case), name="createCase"),
    path("viewCase/", login_required(views.view_cases), name="viewCase"),
]
