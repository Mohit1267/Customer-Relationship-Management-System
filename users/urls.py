...
urlpatterns = [
    ...
    path("password_reset_complete/", authentication_views.PasswordResetCompleteView.as_view(template_name="users/password_reset_complete.html"), name="password_reset_complete"),
